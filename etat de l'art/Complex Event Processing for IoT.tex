...
\begin{figure}[H]
	\includegraphics[width=\textwidth,height=160pt]{assets/SPS_Architecture.png}
...
\begin{figure}[H]
	\includegraphics[width=\textwidth,height=160pt]{assets/simple_SPS_example.png}
...
10. The Smart Lightning process sends the Switch off lamp event.
