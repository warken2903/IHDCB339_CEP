...
The article \cite{Towards-a-context-driven-platform} proposes an Internet of Things architecture to reduce the energy consumption of a building. Studies demonstrated that using ICT technologies could reduce the energy consumption of a building by 70 percent. Different automatic processes have been put in place to control the ventilation, heating and air conditioning control based on data coming from the sensors. Different algorithms were tested to provide a better way to maintain the heating and air quality of the building with the lowest energy consumption.
